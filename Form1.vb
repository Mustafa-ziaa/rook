...
Public Class Form1
    ...
    Private Sub PlayerAct(sender As Object, e As EventArgs)
        ...
        Dim status_str As String = "round" & CStr(thisRnd.round) & ", "
        If thisRnd.diff = 0 Then
            status_str = status_str & "Easy, "
        ElseIf thisRnd.diff = 1 Then
            status_str = status_str & "Normal, "
        ElseIf thisRnd.diff = 2 Then
            status_str = status_str & "Hard, "
        End If

        If thisRnd.winner = 0 Then
            status_str = status_str & "Player wins"
            With lb_Result
                .Text = "Player wins"
                .ForeColor = Color.Green
            End With
        ElseIf thisRnd.winner = 1 Then
            status_str = status_str & "Computer wins"
            With lb_Result
                .Text = "Computer wins"
                .ForeColor = Color.Red
            End With
        ElseIf thisRnd.winner = 2 Then
            status_str = status_str & "Draw"
            With lb_Result
                .Text = "Draw"
                .ForeColor = SystemColors.ControlText
            End With
    ...
    Private Sub CredictToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CredictToolStripMenuItem.Click
        MsgBox("Wave Hand by Tom Fricker from the Noun Project" & vbCrLf &
            ...
            "Source code is available on github.com/perryOnCrack/Rock-Paper-Scissors-VB", MsgBoxStyle.Information, "Acknowledgements")
        '
    End Sub
    ...
    Private Sub SaveToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SaveToolStripMenuItem.Click
        If stats.Count <> 0 Then
            ...
            End If
        Else
            MsgBox("No data to save!!", MsgBoxStyle.Information, "")
        End If
    End Sub
